  ...
  plugins: [
    ...
    monkey({
      ...
      userscript: {
        ...
        // Decision-model default hosts are listed for the same reason: requests held behind the prompt hit the 8 s decision timeout.
        connect: ['api.deepgram.com', 'api.typesafe.ai', 'openrouter.ai', 'localhost', '127.0.0.1', '*'],
