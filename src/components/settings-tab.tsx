  ...
  return (
    <Accordion>
      ...
      <AccordionItem
        ...
        onOpenChange={v => {
          settingsFeaturesOpen.value = v
        }}
        className={ACCORDION_ITEM_CLASS}
      >
        <AccordionTrigger>功能切换</AccordionTrigger>
      ...
      <AccordionItem
        ...
        onOpenChange={v => {
          settingsRulesOpen.value = v
        }}
        className={ACCORDION_ITEM_CLASS}
      >
        <AccordionTrigger>替换规则</AccordionTrigger>
        <AccordionContent className={ACCORDION_CONTENT_CLASS}>
      ...
      <AccordionItem
        ...
        onOpenChange={v => {
          settingsBlacklistOpen.value = v
        }}
        className={ACCORDION_ITEM_CLASS}
      >
        <AccordionTrigger>自动融入黑名单</AccordionTrigger>
        <AccordionContent className={ACCORDION_CONTENT_CLASS}>
          <div class={SUB_SECTION_CLASS}>
            <div class={HEADING_CLASS}>
              观众黑名单
      ...
      <AccordionItem
        ...
        onOpenChange={v => {
          settingsAutoSeekOpen.value = v
        }}
        className={ACCORDION_ITEM_CLASS}
      >
        <AccordionTrigger>播放器追帧</AccordionTrigger>
        <AccordionContent className={ACCORDION_CONTENT_CLASS}>
          <div class={HINT_CLASS}>
      ...
      <AccordionItem
        ...
        className={ACCORDION_ITEM_CLASS}
      >
        <AccordionTrigger>用户备注</AccordionTrigger>
        <AccordionContent className={ACCORDION_CONTENT_CLASS}>
          <div class={HINT_CLASS}>
      ...
      <AccordionItem
        open={settingsImportExportOpen.value}
        onOpenChange={v => {
          settingsImportExportOpen.value = v
        }}
        className={ACCORDION_ITEM_CLASS}
      >
        <AccordionTrigger>导入 / 导出设置</AccordionTrigger>
        <AccordionContent className={ACCORDION_CONTENT_CLASS}>
          <div class={HINT_CLASS}>
